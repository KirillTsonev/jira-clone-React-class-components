...
class AppBoardInProgress extends Component {
    onStatusChange = (id) => {
        ...
        return (
            <>
                <div className="board__column">
                    <h2 className="board__column__heading">In progress</h2>
...
export default AppBoardInProgress